...
<main id="main-content">
	...
	<table class='table-border'>
		...
		if ((count($parentResourceArray) > 0) || (count($childResourceArray) > 0)){ ?>
			<tr>
			<td><?php echo _("Related Products:");?></td>
			<td>
			<?php
      ...
      foreach ($parentResourceArray as $parentResource){
		...
		<tr>
		<td><?php echo _("Organizations:");?></td>
		<td>
	...
	?>
		<table class='table-border'>
			...
			<?php foreach ($noteArray as $resourceNote){ ?>
				<tr>
				<td><?php echo $resourceNote['noteTypeName']; ?>:</td>
	...
	<?php if ($resource->acquisitionTypeID) { ?>
		<tr>
		<td><?php echo _("Acquisition Type:");?></td>
	...
	<?php if ($resource->systemNumber) { ?>
		<tr>
		<td><?php echo _("System Number:");?></td>
	...
	<tr>
	<td><?php echo _("Current Sub End:");?></td>
	...
	<tr>
        <th colspan='2' style='vertical-align:bottom;'>
	<span ><?php echo _("Cost History");?></span>
	</th>
	</tr>
	...
	<br />
<!-- TODO: eliminate table -->
	<table class='table-border'>
	<tr>
	<th colspan='2'>
	<span ><?php echo _("License");?></span>
	</th>
	</tr>
	...
	?>
		<table class='table-border'>
			...
			<?php foreach ($noteArray as $resourceNote){ ?>
				...
				<td><?php echo nl2br($resourceNote['noteText']); ?>
	...
	<table class='table-border'>
	<tr>
	<th colspan='2' scope="col"><?php echo _("Access Information");?></th>
	</tr>
	...
	<?php if ($authenticationType->shortName) { ?>
		<tr>
		<th scope="row"><?php echo _("Authentication Type:");?></th>
	...
	<?php if (($resource->authenticationUserName) || ($resource->authenticationPassword)) { ?>
		<tr>
		<th scope="row"><?php echo _("Username / Password:");?></th>
	...
	<?php if ($userLimit->shortName) { ?>
		<tr>
		<th scope="row"><?php echo _("Simultaneous User Limit:");?></th>
	...
	<?php if ($resource->registeredIPAddressException){ ?>
		<tr>
		<th scope="row"><?php echo _("Registered IP Address:");?></th>
		<td><?php echo $resource->registeredIPAddressException; ?></td>
		</tr>
	<?php } ?>
	...
	<?php if ($storageLocation->shortName) { ?>
		<tr>
		<th scope="row"><?php echo _("Storage Location:");?></th>
	...
	<?php if ($accessMethod->shortName) { ?>
		<tr>
		<th scope="row"><?php echo _("Access Method:");?></th>
	...
	?>
		<table class='table-border'>
			<tr>
			<th colspan='2' scope="col"><?php echo _("Additional Access Notes");?></th>
			</tr>
			<?php foreach ($noteArray as $resourceNote){ ?>
				<tr>
				<th scope="row"><?php echo $resourceNote['noteTypeName']; ?>:</th>
				<td><?php echo nl2br($resourceNote['noteText']); ?><br /><i><?php echo format_date($resourceNote['updateDate']) . _(" by ") . $resourceNote['updateUser']; ?></i></td>
				</tr>
			<?php } ?>
		</table>
    ...
    <?php if ($resourceAcquisition->hasCatalogingInformation()) { ?>
      <?php if ($resourceAcquisition->recordSetIdentifier) { ?>
    	...
    	<?php if ($resourceAcquisition->catalogingTypeID) {
    		...
    		?>
    		<tr>
      		<th scope="row"><?php echo _("Cataloging Type:");?></th>
  ...
  <br />
	...
	?>
		<table class='table-border'>
			<tr>
			<th colspan='2' scope="col"><?php echo _("Additional Cataloging Notes");?></th>
			</tr>
			<?php foreach ($noteArray as $resourceNote){ ?>
				<tr>
				<th scope="row"><?php echo $resourceNote['noteTypeName']; ?>:</th>
