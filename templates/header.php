  ...
  <div id="utilities">
    <nav id="account" aria-label="<?php echo _('Account and Help'); ?>">
      ...
      <ul>
        ...
        <?php } ?>
        <li><a href='http://docs.coral-erm.org/' id="docs" target="_blank"><?php echo _("Help"); ?></a>
        ...
        <!-- TODO: use LangCodes.php? -->
        <li id="setLanguage">
            <select name="lang" id="lang" class="dropDownLang" aria-label="<?php echo _("Language");?>">
                <?php
