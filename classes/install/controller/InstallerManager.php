<?php 
    ...
    class InstallerManager {
        ...
        */
        ...
        private function displayErrorAndStop($errorMsg){
            $invalidErrorMessage = [
            ...
            new view\errorMessage($errorMessageView);
            exit;
        }
        ...
        private function getInstallVersions(){
            $versionInstallArray = $this->validVersionOrder;
            array_unshift($versionInstallArray, "Install");
        ...
        private function getUpgradeVersions(){
            ...
            $versionUpgradeArray = array_slice($this->validVersionOrder, $firstUpgradeIndex);
        ...
        private function validateVersions(){
            ...
            foreach($errorChecks as $testFailed){
                if($testFailed){
                    $this->displayErrorAndStop($testFailed);
                }
            }
        }
    }
