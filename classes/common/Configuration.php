...
class Configuration extends DynamicObject {
	...
	public function init(NamedArguments $arguments) {
		$global_config = parse_ini_file(CORAL_DIR . "/common/configuration.ini", true);
		$arguments->setDefaultValueForArgumentName("filename", MODULE_DIR . "/admin/configuration.ini");
