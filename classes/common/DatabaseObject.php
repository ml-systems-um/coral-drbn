...
class DatabaseObject extends DynamicObject {
	...
	protected function init(NamedArguments $arguments) {
		//Because I'm introducing Namespaces here, we need to make sure we avoid adding the namespace to the table name.
		$classWithoutNamespace = ((new \ReflectionClass($this))->getShortName());
		$arguments->setDefaultValueForArgumentName('tableName', $classWithoutNamespace);
